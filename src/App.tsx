...
function App() {
  ...
  const fallbackReply =
    "I'm sorry, I couldn't find information about that. Would you like to ask about admissions, examinations, results, fees, courses, or contact support?";
  ...
  const universityInfo = {
      ...
      <>
        ...
        <div className="mt-4 flex flex-col gap-3 w-full max-w-xs">
          ...
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 w-full"
            onClick={() => {
              handleSendMessage("CDOE Distance Education");
              window.open(
    ...
    examination: (
      <>
        Examinations are conducted twice a year (Winter and Summer). The
        schedule is published on the university website one month before exams.
        Students must register through the MU portal.
        <br />
        <button
          className="mt-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700"
          onClick={() => {
    ...
    result: (
      <>
        <strong>which Result do you want to know more?</strong>
        <br />
        <div className="mt-4 flex flex-col gap-3 w-full max-w-xs">
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 w-full"
    ...
    Convocation: (
      <>
        Fee structure varies by course and department. Undergraduate programs
        range from ₹5,000 to ₹25,000 per semester. Postgraduate programs range
        from ₹15,000 to ₹50,000 per semester.
        <br />
        <a
          href="https://mu.ac.in/fees-structure"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline hover:text-blue-700"
        >
    ...
    "course information": (
      <>
        Mumbai University offers over 550 courses across Arts, Commerce,
        Science, Law, Management, and Technology. Each department has specific
        eligibility criteria and course duration.
        <br />
        <a
          href="https://archive.mu.ac.in/courses/Index-1.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline hover:text-blue-700"
        >
    ...
    scholarship: (
      <>
        ...
        need-based, and category-based financial aid. Applications are typically
        accepted in September-October.
        <br />
        <a
          href="https://mu.ac.in/scholarship"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline hover:text-blue-700"
        >
    ...
    hostel: (
      <>
        University hostels are available at Kalina and Churchgate campuses.
        Applications open in May-June. Monthly fees range from ₹3,000 to ₹7,000
        depending on room type and facilities.
        <br />
        <a
          href="https://mu.ac.in/archives/courses/2074"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline hover:text-blue-700"
        >
    ...
    "online verification": (
      <>
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "https://univ.secur.co.in/University/verification",
              "_blank",
              "noopener,noreferrer"
            )
          }
    ...
    library:
      "The Jawaharlal Nehru Library at Kalina Campus houses over 850,000 books and provides digital access to journals. Its open from 8 AM to 10 PM on weekdays and 10 AM to 6 PM on weekends.",
    placement:
      "The University Placement Cell coordinates campus recruitment. Average placement rates vary by department, with Engineering and Management achieving 85-90% placement. Top recruiters include TCS, Infosys, and HDFC Bank.",
    "degree certificate":
      "For degree certificates, apply through the Examination House at Kalina Campus. Processing takes 30-45 days. Verification fee is ₹1,000 for Indian students and $50 for international students.",
    transcript:
      "Official transcripts can be requested online through mumbaiuniversity.ac.in/transcript. Processing fee is ₹500 per copy for Indian students and $25 for international students.",
    syllabus:
      "Course syllabi are available on respective department websites. For a printed copy, visit the department office or download from mu.ac.in/academics/syllabus.",
    internship:
      "Internship opportunities are coordinated through individual departments. The University Industry Interaction Cell also facilitates internships with partner organizations.",
    document:
      "Required documents typically include ID proof, address proof, previous educational certificates, caste certificate (if applicable), and passport-sized photographs. Specific requirements vary by program.",
    eligibility:
      "Eligibility criteria vary by program. Generally, undergraduate programs require 50-60% in 12th standard, while postgraduate programs require 50-60% in relevant bachelor's degree.",
    campus:
      "Mumbai University has multiple campuses including Kalina (Santacruz), Fort, Thane, and Kalyan. The main administrative campus is at Fort, while most departments are at Kalina Campus.",
    faculty:
      "The university has over 2,000 faculty members across departments, with approximately 70% holding doctoral degrees. Faculty-student ratio averages 1:25 across programs.",
    research:
      "Research opportunities are available through various centers of excellence. PhD programs are offered in most departments. Research funding is available through university grants and external agencies.",
    alumni:
      "Notable alumni include industrialist Ratan Tata, cricketer Sunil Gavaskar, and former President Pratibha Patil. The Alumni Association organizes regular networking events and mentorship programs.",
    ranking:
      "Mumbai University consistently ranks among the top 10 universities in India. It holds NAAC A grade accreditation and is recognized by UGC, AICTE, and other regulatory bodies.",
    exchange:
      "International exchange programs are available with partner universities in the US, UK, Australia, and Germany. Applications open in January for fall semester and August for spring semester.",
    online:
      "Several programs are offered in distance learning mode through the Institute of Distance and Open Learning (IDOL). Online application, study materials, and examinations are conducted regularly.",
    counseling:
      "Student counseling services are available at the Student Welfare Department. Free counseling sessions can be booked through the university portal or by visiting the department.",

    "academic calendar": (
      <>
        The academic calendar typically runs from June to April, with winter
        break in December and summer break in May. Detailed schedules are
        published on the university website at the beginning of each academic
        year.
        <br />
        <a
          href="https://mu.migrationcertificate.in/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-blue-500 underline hover:text-blue-700"
        >
    ...
    "migration certificate": (
      <>
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "https://mu.migrationcertificate.in/",
              "_blank",
              "noopener,noreferrer"
            )
          }
  ...
  const searchDatabase = (query: string): string | JSX.Element => {
    ...
    if (
      lastQuery === "admission process" &&
      (normalizedQuery === "ug" || normalizedQuery === "pg")
    ) {
      return (
        universityInfo[normalizedQuery] || "Please specify the course name."
      );
    }
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center relative">
      ...
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-600">
          Welcome to the official website of Mumbai University
        </p>
